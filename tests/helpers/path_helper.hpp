...
public:
    ...
    {
        static const std::string data_dir = XLNT_DETAIL_ENSURE_UTF8_LITERAL(XLNT_TEST_DATA_DIR);
    ...
    {
        static const std::string data_dir = XLNT_DETAIL_ENSURE_UTF8_LITERAL(XLNT_BENCHMARK_DATA_DIR);
        return xlnt::path(data_dir);
    }
    ...
    {
        static const std::string data_dir = XLNT_DETAIL_ENSURE_UTF8_LITERAL(XLNT_SAMPLE_DATA_DIR);
        return xlnt::path(data_dir);
    }
