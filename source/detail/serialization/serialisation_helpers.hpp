...
struct Cell_Reference
{
    ...
    xlnt::row_t row; // default range: [1, 1048576], but XLNT allows [1, 4294967295]
    xlnt::column_t::index_t column; // default range: ["A", "XFD"] -> [1, 16384], but XLNT allows [1, 4294967295]
};
